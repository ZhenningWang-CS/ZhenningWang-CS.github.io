...
window.SITE = {
  ...
  bio: {
    ...
    zh: "我于 2026 年 7 月加入<a href='https://cs.njust.edu.cn/' target='_blank' rel='noopener'>计算机科学与工程学院</a>，<a href='https://www.njust.edu.cn/' target='_blank' rel='noopener'>南京理工大学</a>，担任副教授(副高级)，隶属于<a href='https://www.junlongzhou.team/' target='_blank' rel='noopener'>周俊龙教授</a>的研究团队。2026 年 6 月，我在武汉大学国家网络安全学院获得博士学位，导师为<a href='http://yuecao.e.zwz.hk/zh' target='_blank' rel='noopener'>曹越教授</a>。在此之前，我于 2022 年获得硕士学位，导师为西北工业大学<a href='https://www.scholat.com/huanzhou' target='_blank' rel='noopener'>周欢教授</a>。我已在 IEEE TMC、IEEE COMST 等顶级期刊和会议发表 16 篇论文，含两篇 ESI 高被引论文。我的研究方向包括移动群智感知、边缘智能和车联网等。"
  },
